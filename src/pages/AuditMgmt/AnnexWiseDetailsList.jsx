                ...
                <li className="breadcrumb-item active" aria-current="page">
                  ...
                  <PageTitle
                    breadCrumbItems={[
                      ...
                      {
                        label: "Annex-wise details listing",
                        path: "/Audit",
                        active: true,
                      },
                    ]}
                            ...
                            QuizList?.map((record, index) => {
                              return (
                                <tr key={index}>
                                  ...
                                  <td>
                                    <Link
                                      to={`/AnnexWiseAuditDetailUpdate?id=${record?.id}`}
...
export default AnnexWiseDetailsList;
